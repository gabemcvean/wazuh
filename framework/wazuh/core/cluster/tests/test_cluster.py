...
@pytest.mark.parametrize('merge_type, filename', [
    ("../etc", "payload.merged"),
    ("..\\etc", "payload.merged"),
    (".hidden", "payload.merged"),
    ("valid/path", "payload.merged"),
    ("valid", "../../../etc/ossec.conf"),
    ("valid", "..\\..\\..\\etc\\ossec.conf"),
    ("valid", ".hidden"),
    ("valid", "file/with/slash"),
])
def test_unmerge_info_path_validation(merge_type, filename):
